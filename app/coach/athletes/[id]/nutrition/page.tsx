      ...
      <div>
        ...
        <nav style={{ padding: '12px' }}>
          ...
          <div style={{ margin: '8px 0 4px', padding: '0 12px' }}>
            <div style={{ fontSize: '10px', color: 'rgba(255,255,255,0.25)', textTransform: 'uppercase' as const, letterSpacing: '0.08em', marginBottom: '6px' }}>{athleteName.split(' ')[0]}</div>
          </div>
...
function MacroCard({ title, emoji, calories, protein, carbs, fat }: { title: string; emoji: string; calories: number; protein: number; carbs: number; fat: number }) {
  ...
  return (
    <div style={{ background: '#FFFFFF', border: '1px solid #E2E8F0', borderRadius: '12px', padding: '24px' }}>
      ...
      <div style={{ fontSize: '14px', fontWeight: 700, color: '#0F2044', marginBottom: '16px' }}>{title}</div>
      <div style={{ fontSize: '36px', fontWeight: 800, color: '#0F2044', marginBottom: '4px' }}>
        {calories} <span style={{ fontSize: '16px', color: '#94A3B8', fontWeight: 500 }}>kcal</span>
      </div>
        ...
        {[
          ...
          <div key={m.label}>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '4px' }}>
              <span style={{ fontSize: '13px', fontWeight: 600, color: '#334155' }}>{m.label}</span>
              <span style={{ fontSize: '13px', color: '#94A3B8' }}>{m.g}g · {m.pct}%</span>
            </div>
